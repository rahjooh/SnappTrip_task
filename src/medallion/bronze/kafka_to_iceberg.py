...
class BronzeIngestion:
    ...
    def ingest_bookings(self):
        ...
        # Read from Kafka
        bookings_df = self.read_kafka_stream("bookings_raw", BOOKING_SCHEMA)
    ...
    def ingest_events(self):
        ...
        # Read from Kafka
        events_df = self.read_kafka_stream("booking_events_raw", BOOKING_EVENT_SCHEMA)
    ...
    def ingest_hotels(self):
        ...
        # Read from Kafka
        hotels_df = self.read_kafka_stream("hotels_raw", HOTEL_SCHEMA)
